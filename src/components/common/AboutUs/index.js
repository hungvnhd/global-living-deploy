		...
		<section className="AboutUs" id="AboutUs">
					...
					{!isZoomLocate ? (
						<>
							<div className="AboutUs__logo-icon">
								<img
									src="/images/icons/vision-icon-1.png"
									alt="icon"
								/>
							</div>
			...
			>
				...
				<div className="AboutUs__logo" style={{ cursor: "pointer" }}>
					{!isZoomMission ? (
						<>
							<div className="AboutUs__logo-icon">
								<img
									src="/images/icons/vision-icon-3.png"
									alt="icon"
								/>
							</div>
							<h2>SỨ MỆNH</h2>
				...
				>
					<h3>Sứ mệnh</h3>
					<p>
						Sứ mệnh của Global Living là đồng hành cùng khách hàng
						qua từng bước trên hành trình đầu tư bất động sản cao
						cấp tại các quốc gia phát triển. Không chỉ dừng lại ở
						những sản phẩm đầu tư quốc tế với chất lượng vượt trội,
						chúng tôi còn mong muốn hỗ trợ khách hàng sở hữu tấm thẻ
						định cư quý giá để tận hưởng những lợi ích của một công
						dân toàn cầu. Giúp cho khách hàng hiện thực hóa ước mơ
						sống và làm việc tại một môi trường an toàn, tiện nghi
						với chất lượng cuộc sống đẳng cấp chính là nhiệm vụ của
						Global Living. Chúng tôi tự hào là đối tác đáng tin cậy
						của khách hàng, và luôn nỗ lực để mang đến cho họ sự hài
						lòng và những trải nghiệm tốt nhất trên con đường thành
						công và thịnh vượng.
					</p>
				</div>
			</div>
