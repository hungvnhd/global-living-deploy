				...
				<div className="CoreProduct__detail">
					...
					<div className="CoreProduct__detail-more first">
						<div className="CoreProduct__detail-more--item">
							...
							<p className="price" onClick={navigateToContact}>
								1.6 tỉ đồng
							</p>
						</div>
						<div className="CoreProduct__detail-more--item">
					...
					<div className="CoreProduct__detail-more">
						...
						<div className="CoreProduct__detail-more--item">
							<Link
								href={
									"https://info.globalliving-group.com/hungary?fbclid=IwAR2hyJCSClRp4e-rkqJR63DoTRQnDVBzXs0776Ead3lyjVmBK4RU8u19qWU"
								}
								target="_blank"
								className="price"
